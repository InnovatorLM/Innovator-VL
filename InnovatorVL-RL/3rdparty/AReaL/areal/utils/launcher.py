...
# Use custom cache directory if specified, otherwise use default
_DEFAULT_CACHE_BASE = os.getenv("AREAL_CACHE_BASE", "/mnt/innovator/code/wenzichen/.cache")
LOCAL_CACHE_DIR = os.getenv("AREAL_LOCAL_CACHE_DIR", f"{_DEFAULT_CACHE_BASE}/areal")
