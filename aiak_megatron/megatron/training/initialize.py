...
from megatron.training.global_vars import _set_tensorboard_writer, set_global_variables
...
def initialize_megatron(
    ...
    if args.tensorboard_dir and mpu.get_tensor_model_parallel_rank() == 0:
        try:
            from torch.utils.tensorboard import SummaryWriter
            print(f"> setting up tensorboard-writer in {args.tensorboard_dir}")
            writer = SummaryWriter(
                log_dir=args.tensorboard_dir,
                max_queue=args.tensorboard_queue_size)
            _set_tensorboard_writer(writer)
