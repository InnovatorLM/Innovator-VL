...
@dataclass
class InnovatorVlConfig:
    """config for innovator vl model"""
    num_layers: int
    hidden_size: int
    ffn_hidden_size: int
...
@register_model_config(model_family=VisionLanguageModelFamilies.INNOVATOR_VL, model_arch="innovator-vl-3b")
def innovator_vl_3b():
    """innovator-vl-3b"""
    return InnovatorVlConfig(
        num_layers=36,
        hidden_size=2048,
...
@register_model_config(model_family=VisionLanguageModelFamilies.INNOVATOR_VL, model_arch="innovator-vl-4b")
def innovator_vl_4b():
    """innovator-vl-4b"""
    return InnovatorVlConfig(
        num_layers=36,
...
@register_model_config(model_family=VisionLanguageModelFamilies.INNOVATOR_VL, model_arch="innovator-vl-30b-a3b")
def innovator_vl_30b_a3b():
    """innovator-vl-30b-a3b"""
    return InnovatorVlConfig(
        num_layers=48,
        hidden_size=2048,
...
@register_model_config(model_family=VisionLanguageModelFamilies.INNOVATOR_VL, model_arch="innovator-vl-8b")
def innovator_vl_8b():
    """innovator-vl-8b"""
    return InnovatorVlConfig(
        num_layers=36,
...
@register_model_config(model_family=VisionLanguageModelFamilies.INNOVATOR_VL, model_arch="innovator-vl-32b")
def innovator_vl_32b():
    """innovator-vl-32b"""
    return InnovatorVlConfig(
        num_layers=64,
        hidden_size=5120,
...
@register_model_config(model_family=VisionLanguageModelFamilies.INNOVATOR_VL, model_arch="innovator-vl-14b")
def innovator_vl_14b():
    """innovator-vl-14b"""
    return InnovatorVlConfig(
        num_layers=40,
        hidden_size=5120,
