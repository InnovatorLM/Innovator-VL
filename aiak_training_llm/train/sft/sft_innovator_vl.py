...
def default_pretrain_trainer(train_args):
    """build trainer"""
    from aiak_training_llm.train.pretrain import pretrain_innovator_vl
    ...
    trainer = MegatronTrainer(
        ...
        train_valid_test_dataset_provider=pretrain_innovator_vl.train_valid_test_dataset_provider,
        model_provider=pretrain_innovator_vl.model_provider,
        model_type=model_type,
        forward_step_func=pretrain_innovator_vl.forward_step,
    )
